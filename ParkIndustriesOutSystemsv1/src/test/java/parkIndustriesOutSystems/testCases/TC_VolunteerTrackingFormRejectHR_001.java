...
public class TC_VolunteerTrackingFormRejectHR_001 extends BaseClass {
	...
	public void  parkSupervisorApprovalProcess2() throws InterruptedException, IOException 
	{
		...
		pau.waitForPageLoaded();
		vf.txtAddCommentPSDisplayed();
		logger.info("\"Add Comment (Optional)\" text is displayed");
		
		vf.inputAddCommentPSDisplayed();
		logger.info("Add Comment (Optional) field is displayed");
		
		vf.btnCancelPSDisplayed();
		logger.info("Cancel Button is displayed");
		
		vf.btnApprovePSDisplayed();
	...
	public void  parkSupervisorApprovalProcess3() throws InterruptedException, IOException 
	{
		...
		logger.info("User is taken to Volunteer Grant Request form");
	...
	@Test (priority=18)
	public void  parkSupervisorApprovalProcess6() throws InterruptedException, IOException 
	{
		VolunteerForm vf= new VolunteerForm(driver);
		ParkAssociateUser pau= new ParkAssociateUser(driver);
		
		pau.waitForPageLoaded();
		vf.tagApprovedBySupervisorDisplayed();
		logger.info("Approved by Supervisor tag is displayed");
		
		vf.txtStatusChangedByParkSupervisorUserDisplayed();
		logger.info("\"Status changed by Park Supervisor User\" text is displayed");
		
		vf.txtApprovedBySupervisorDisplayed();
	...
	@Test (priority=22)
	public void  hrConfirmationRejection2() throws InterruptedException, IOException 
	{
		VolunteerForm vf= new VolunteerForm(driver);
		ParkAssociateUser pau= new ParkAssociateUser(driver);
		
		pau.waitForPageLoaded();
		vf.txtAddCommentHRDisplayed();
		logger.info("\"Add Comment* (Mandatory)\" text is displayed");
		
		vf.btnCancelPSDisplayed();
		logger.info("Close Button is displayed");
		
		vf.btnReject2Displayed();
	...
	@Test (priority=23)
	public void  hrConfirmationRejection3() throws InterruptedException, IOException 
	{
		VolunteerForm vf= new VolunteerForm(driver);
		ParkAssociateUser pau= new ParkAssociateUser(driver);
	...
	@Test (priority=24)
	public void  hrConfirmationRejection4() throws InterruptedException, IOException 
	{
		VolunteerForm vf= new VolunteerForm(driver);
		ParkAssociateUser pau= new ParkAssociateUser(driver);
	...
	@Test (priority=25)
	public void  hrConfirmationRejection5() throws InterruptedException, IOException 
	{
		VolunteerForm vf= new VolunteerForm(driver);
		ParkAssociateUser pau= new ParkAssociateUser(driver);
